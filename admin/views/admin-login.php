...
if (isset($_SESSION['username'])) {
    ...
    header('Location: dashboard.php'); // หรือไปยังหน้าที่คุณต้องการ
    exit();
    ...
    if ($result->num_rows > 0) {
        ...
        header('Location: dashboard.php'); // ให้พนักงานไปยังหน้า dashboard ของพนักงาน
        exit();
    } else {
        include('../../public/assets/popup/admin-not_found.html');
    }
