<?php
include('../controller/user-regis.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <script src="../../public/js/cur-date.js"></script>
...
<body>
    <div class="container mt-5">
        ...
        <h2 class="text-center" style="margin-bottom: 10px;"> <img style="width: 10%;" src="../../public/img/logo.webp" alt="logo"> สมัครสมาชิก</h2>
        <div class="card bg-light p-4">
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <!--<input type="datetime-local" id="regdate" name="regdate" style="display: none;" required>
                    <script>
                        // สร้างวัตถุวันที่และเวลาปัจจุบัน
                        var now = new Date();

                        // รับวันที่และเวลาปัจจุบันในรูปแบบที่เหมาะสำหรับฟิลด์ datetime-local
                        var currentDateTime = now.toISOString().slice(0, 16);

                        // ตั้งค่าค่าเริ่มต้นของฟิลด์
                        document.getElementById("regdate").value = currentDateTime;
                    </script>-->
